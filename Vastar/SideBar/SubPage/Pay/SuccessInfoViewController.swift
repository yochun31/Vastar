...
class SuccessInfoViewController: UIViewController {
    ...
    func setInterface() {
        ...
        self.infoTitleLabel.text = NSLocalizedString("Pay_Success_Title", comment: "")
        ...
        self.infoLabel.text = NSLocalizedString("Pay_Success_Info_Text", comment: "")
