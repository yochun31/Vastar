//
//  OrderDoneDetailViewController.swift
//  Vastar
//
//  Created by 郭堯彰 on 2021/9/13.
//

import UIKit

class OrderDoneDetailViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
