...
class HistoryOrderViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet var historyOrderTableView: UITableView!
    ...
    func setTableView() {
        self.historyOrderTableView.delegate = self
        self.historyOrderTableView.dataSource = self
        self.historyOrderTableView.separatorStyle = .none
        self.historyOrderTableView.register(UINib(nibName: "OrderListTableViewCell", bundle: nil), forCellReuseIdentifier: "historyOrderCell")
        
        self.historyOrderTableView.backgroundColor = UIColor.init(red: 0.0/255.0, green: 36.0/255.0, blue: 22.0/255.0, alpha: 1.0)
    }
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:OrderListTableViewCell = tableView.dequeueReusableCell(withIdentifier: "historyOrderCell", for: indexPath) as! OrderListTableViewCell
