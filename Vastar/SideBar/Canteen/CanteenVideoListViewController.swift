//
//  CanteenVideoListViewController.swift
//  Vastar
//
//  Created by 郭堯彰 on 2022/5/31.
//

import UIKit

class CanteenVideoListViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func setInterface() {
        self.navigationItem.title = NSLocalizedString(self.seriesSt, comment: "")
...
//        self.revealViewController()?.delegate = self
    ...
    func getVideoAllList() {
        ...
        VClient.sharedInstance().VCGetVideoListBySeries(series: self.seriesSt) { (_ isSuccess:Bool,_ message:String,_ resDataArray:Array<Array<Any>>) in
            if isSuccess {
